...
cd /pylon5/mc3bggp/aymen/radical.pilot.sandbox/rp.session.js-17-21.jetstream-cloud.org.aymen.018292.0007/pilot.0000
...
export PYTHONPATH=/pylon5/mc3bggp/aymen/radical.pilot.sandbox/rp.session.js-17-21.jetstream-cloud.org.aymen.018292.0007/pilot.0000/rp_install/lib/python2.7/site-packages::
...
exec /pylon5/mc3bggp/aymen/radical.pilot.sandbox/ve.xsede.bridges.0.70.0/bin/python /pylon5/mc3bggp/aymen/radical.pilot.sandbox/rp.session.js-17-21.jetstream-cloud.org.aymen.018292.0007/pilot.0000/rp_install/bin/radical-pilot-agent "$1" 1>"$1.out" 2>"$1.err"
