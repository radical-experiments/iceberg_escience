...
cd /pylon5/mc3bggp/aymen/radical.pilot.sandbox/design2a_11k_test5/pilot.0000

# apply some env settings as stored after running pre_bootstrap_0 commands
export PATH="/opt/packages/python/2_7_11_gcc/bin:/opt/packages/slurm/default/bin:/usr/mpi/gcc/openmpi-2.1.2-hfi/bin:/opt/packages/gcc/9.2.0/bin:/usr/lib64/qt-3.3/bin:/usr/lib64/ccache:/usr/local/bin:/bin:/usr/bin:/usr/bin:/usr/local/sbin:/usr/sbin:/opt/puppetlabs/puppet/bin:/bin:/sbin:/opt/puppetlabs/bin:/home/aymen/.local/bin:/home/aymen/bin:/opt/puppetlabs/puppet/bin:/bin:/sbin:/home/aymen/.local/bin:/home/aymen/bin"
...
then
    source activate /pylon5/mc3bggp/aymen/radical.pilot.sandbox/ve.xsede.bridges.0.73.1/
else
    . /pylon5/mc3bggp/aymen/radical.pilot.sandbox/ve.xsede.bridges.0.73.1/bin/activate
fi

# make sure rp_install is used
export PYTHONPATH=/pylon5/mc3bggp/aymen/radical.pilot.sandbox/design2a_11k_test5/pilot.0000/rp_install/lib/python2.7/site-packages::
...
exec /pylon5/mc3bggp/aymen/radical.pilot.sandbox/ve.xsede.bridges.0.73.1/bin/python /pylon5/mc3bggp/aymen/radical.pilot.sandbox/design2a_11k_test5/pilot.0000/rp_install/bin/radical-pilot-agent "$1" 1>"$1.out" 2>"$1.err"
