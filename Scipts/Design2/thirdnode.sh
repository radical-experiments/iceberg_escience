...
sleep 1
python tilling.py --name tilling17 --scale_bands 299 --output_folder $NODE_LFS_PATH --queue_in /pylon5/mc3bggp/mturilli/Des3Test/discovered.queue.url --queue_out tilled.queue.url > tilling1.log &
python tilling.py --name tilling18 --scale_bands 299 --output_folder $NODE_LFS_PATH --queue_in /pylon5/mc3bggp/mturilli/Des3Test/discovered.queue.url --queue_out tilled.queue.url > tilling2.log &
python tilling.py --name tilling19 --scale_bands 299 --output_folder $NODE_LFS_PATH --queue_in /pylon5/mc3bggp/mturilli/Des3Test/discovered.queue.url --queue_out tilled.queue.url > tilling3.log &
