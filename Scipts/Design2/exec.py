...
if __name__ == '__main__':
    ...
    try:
        ...
        cud.arguments = ['q1.py','--queue=/pylon5/mc3bggp/mturilli/Des3Test/discovered']
        ...
        cud.arguments = ['disc.py','--name=discovery',
                                   '--queue_file=/pylon5/mc3bggp/mturilli/Des3Test/discovered.queue.url',
        ...
        cud.input_staging  = [{'source': 'client:///firstnode.sh', 'target': 'unit:///firstnode.sh', 'action': rp.TRANSFER},
                              ...
                              {'source': 'client:///tilling.py', 'target': 'unit:///tilling.py', 'action': rp.TRANSFER}]
